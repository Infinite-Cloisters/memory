...
public:
	std::unordered_map<std::string, int> _commandHash{ {"cls",0},{"save",1},{"exit",2},{"input",3},};
	std::unordered_map<char, int> _priority{ {'+',1},{'-',1},{'(',1},{'*',2},{'/',2},{'%',2},{'*',2},{'^',2} };
	std::unordered_map<char, int> _action{ {'+',1},{'-',2},{'*',3},{'/',4},{'^',5},{'%',6} };
